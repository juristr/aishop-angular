...
vi.mock('@aishop/ui-product-detail', () => ({
  UiProductDetail: () => <div data-testid="mock-product-detail">Mock Product Detail UI</div>
}));
...
describe('FeatProductDetail Component', () => {
  ...
  describe('Basic rendering', () => {
    ...
    it('should show data access value', async () => {
      ...
      render(<FeatProductDetail />);
      expect(screen.getByText('Data access value: mocked-products-data')).toBeTruthy();
    });
  ...
  describe('Related products', () => {
    it('should fetch similar products', async () => {
      ...
      const currentProduct = { id: 1, category: 'Electronics', tags: ['wireless', 'audio'] };
      const allProducts = [
    ...
    it('should limit related products display', async () => {
      await new Promise(resolve => setTimeout(resolve, 300));
      const relatedProducts = Array(20).fill(null).map((_, i) => ({ id: i }));
  ...
  describe('SEO and sharing', () => {
    ...
    it('should create share links', async () => {
      ...
      const shareLinks = {
        ...
        email: `mailto:?subject=Check this product&body=${encodeURIComponent(productUrl)}`
      };
